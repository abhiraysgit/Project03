...
public class TestUserHib {
	...
	private static void findByLoginTest() throws Exception {
		...
		UserDTO dto = model.findByLogin("abhisheklacheta@gmail.com");
	...
	public static void addTest() throws Exception {
		...
		dto.setFirstName("Abhishek");
		dto.setLastName("Lacheta");
		dto.setDob(sdf.parse("23/06/2000"));
		dto.setConfirmPassword("Abhi123");
		dto.setPassword("Abhi123");
		dto.setLogin("a123bhisheklacheta@gmail.com");
		dto.setGender("male");
		dto.setUnSuccessfulLogin(0);
		dto.setCreatedBy("admin");
		dto.setModifiedBy("admin");
		dto.setRoleId(2);
		dto.setMobileNo("9109452170");
