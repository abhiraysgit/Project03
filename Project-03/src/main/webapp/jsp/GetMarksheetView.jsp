...
<%@page import="in.co.raystech.controller.GetMarksheetCtl"%>
...
<body style="background-color: cadetblue;" class="pb-5">
	<div>
	...
	<div>
		<form action="<%=ORSView.GET_MARKSHEET_CTL%>" method="post">
			...
			<div class="row">
				...
				<div class="col-md-2">
					<input type="submit" class="btn btn-primary btn-md"
						...
						color="white"><%=ServletUtility.getErrorMessage("rollNo", request)%></font>
				</div>
			...
			<%
				if (dto.getRollNo() != null && dto.getRollNo().trim().length() > 0 && dto.getMaths() > 0) {
			%>
