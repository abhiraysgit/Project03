<%@page import="in.co.raystech.controller.FacultyCtl"%>
...
<body style="background-color: cadetblue;">
	...
	<div class="col-sm-12">
      <div class="input-group">
        ...
        <input type="text" id="datepicker" name="dob" class="form-control" placeholder="Date Of Birth" readonly="readonly" value="<%=DataUtility.getDateString(dto.getdOJ()) %>">
      </div>
    </div>	
	...
	<div class="col-sm-12">
      <div class="input-group">
        ...
        <%=HTMLUtility.getList("collegename", String.valueOf(dto.getCollegeId()), ll)%></div>
      </div>	
	...
	<div class="col-sm-12">
      <div class="input-group">
        ...
        <%=HTMLUtility.getList("subjectname", String.valueOf(dto.getSubjectId()), llist)%></div>
      </div>
	...
	<div class="col-sm-12">
      <div class="input-group">
        ...
        <%=HTMLUtility.getList("coursename", String.valueOf(dto.getCourseId()), lli)%></div>
      </div>
	<font color="red" class="pl-sm-5"> <%=ServletUtility.getErrorMessage("coursename", request)%></font></br></br>
