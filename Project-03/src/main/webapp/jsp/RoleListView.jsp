<%@page import="in.co.raystech.controller.RoleListCtl"%>
...
<body style="background-color: cadetblue;">
	...
	<div>
		<form action="<%=ORSView.ROLE_LIST_CTL%>" method="post">
			...
			<jsp:useBean id="dto" class="in.co.raystech.dto.RoleDTO"
			...
			<div class="row">
				...
				<div class="col-sm-3"><%=HTMLUtility.getList("name", String.valueOf(dto.getId()), rlist)%></div>
				<div class="col-sm-2">
