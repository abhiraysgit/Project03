<%@page import="in.co.raystech.controller.MarksheetListCtl"%>
<%@page import="in.co.raystech.dto.MarksheetDTO"%>
...
<body style="background-color: cadetblue">
	...
	<div>
		<form action="<%=ORSView.MARKSHEET_MERIT_LIST_CTL%>" method="post">
			...
			<div align="center">
				<h1 style="font-size: 40px; padding-top: 24px; color: #162390;"><b>Marksheet Merit
					List </b></h1>
			</div>
			...
			<jsp:useBean id="dto" class="in.co.raystech.dto.MarksheetDTO"
			...
			<div style="margin-left: 87%;" class="pb-2">
				...
				<a href="/Project-03/ctl/JasperCtl" class="btn btn-lg btn-primary "
