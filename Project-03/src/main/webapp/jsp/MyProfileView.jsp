<%@page import="in.co.raystech.controller.MyProfileCtl"%>
...
.log1 {
  ...
  body{
	background-image: url('img/volodymyr-hryshchenko-KZocXyI3kRo-unsplash.jpg');
	background-size:100%;		
}
i.css {
...
<body class="img-fluid" style="background-color: cadetblue" >
	<div class="log1">
	<div class="header">
